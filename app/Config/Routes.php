...
$routes->post('accounting/deduction-batches/(:num)/submit', 'AccountingController::submitDeductionBatch/$1', ['filter' => 'access:accounting.operate']);
...
$routes->post('accounting/deduction-batch-items/(:num)/confirm', 'AccountingController::confirmDeductionResult/$1', ['filter' => 'access:accounting.operate']);
