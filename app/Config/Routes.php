...
$routes->post('store/categories/create', 'StoreController::createCategory', ['filter' => 'role:STORE_SYSTEM,ADMIN']);
$routes->post('store/categories/update', 'StoreController::updateCategory', ['filter' => 'role:STORE_SYSTEM,ADMIN']);
$routes->post('store/categories/delete', 'StoreController::deleteCategory', ['filter' => 'role:STORE_SYSTEM,ADMIN']);
...
$routes->post('store/cash-movements/create', 'StoreController::createCashMovement', ['filter' => 'role:STORE_SYSTEM,ADMIN']);
