...
$routes->post('pos/transactions', 'PosController::createTransaction', ['filter' => 'access:store.checkout']);
...
$routes->get('profile/security', 'ProfileController::securityStatus', ['filter' => 'access:account.self']);
$routes->post('profile/password', 'ProfileController::updatePassword', ['filter' => 'access:account.self']);
$routes->post('profile/debt-pin', 'ProfileController::updateDebtPin', ['filter' => 'access:account.self']);
...
$routes->get('store/pos', 'StoreController::pos', ['filter' => 'access:store.checkout']);
$routes->get('store/dashboard', 'StoreController::dashboard', ['filter' => 'access:store.manage_assigned']);
$routes->get('store/history', 'StoreController::history', ['filter' => 'access:store.manage_assigned']);
$routes->get('store/inventory', 'StoreController::inventory', ['filter' => 'access:store.manage_assigned']);
$routes->get('store/reports', 'StoreController::reports', ['filter' => 'access:store.manage_assigned']);
$routes->get('store/staff-records', 'StoreController::staffRecords', ['filter' => 'access:store.manage_assigned']);
$routes->get('store/settings', 'StoreController::settings', ['filter' => 'access:store.manage_assigned']);
...
$routes->get('store/capabilities', 'StoreController::capabilities', ['filter' => 'access:store.inspect']);
$routes->post('store/capabilities/update', 'StoreController::updateCapabilities', ['filter' => 'access:store.manage_assigned']);
$routes->post('store/categories/create', 'StoreController::createCategory', ['filter' => 'access:store.manage_assigned']);
$routes->post('store/categories/update', 'StoreController::updateCategory', ['filter' => 'access:store.manage_assigned']);
$routes->post('store/categories/delete', 'StoreController::deleteCategory', ['filter' => 'access:store.manage_assigned']);
$routes->get('store/payment-methods', 'StoreController::paymentMethods', ['filter' => 'access:store.inspect']);
$routes->post('store/payment-methods/create', 'StoreController::createPaymentMethod', ['filter' => 'access:store.manage_assigned']);
$routes->post('store/payment-methods/update', 'StoreController::updatePaymentMethod', ['filter' => 'access:store.manage_assigned']);
$routes->post('store/payment-methods/delete', 'StoreController::deletePaymentMethod', ['filter' => 'access:store.manage_assigned']);
$routes->get('store/payment-accounts', 'StoreController::paymentAccounts', ['filter' => 'access:store.inspect']);
$routes->post('store/payment-accounts/save', 'StoreController::savePaymentAccount', ['filter' => 'access:store.manage_assigned']);
$routes->post('store/payment-accounts/upload-qr', 'StoreController::uploadPaymentAccountQr', ['filter' => 'access:store.manage_assigned']);
$routes->post('store/payment-methods/upload-image', 'StoreController::uploadPaymentMethodImage', ['filter' => 'access:store.manage_assigned']);
$routes->post('store/payment-accounts/deactivate', 'StoreController::deactivatePaymentAccount', ['filter' => 'access:store.manage_assigned']);
$routes->get('store/day-session/status', 'StoreController::daySessionStatus', ['filter' => 'access:store.inspect']);
$routes->post('store/day-session/open', 'StoreController::openDaySession', ['filter' => 'access:store.checkout']);
$routes->post('store/day-session/close', 'StoreController::closeDaySession', ['filter' => 'access:store.checkout']);
$routes->get('store/opening-balance/status', 'StoreController::openingBalanceStatus', ['filter' => 'access:store.inspect']);
$routes->post('store/opening-balance/set', 'StoreController::setOpeningBalance', ['filter' => 'access:store.checkout']);
...
$routes->post('store/cash-movements/create', 'StoreController::createCashMovement', ['filter' => 'access:store.checkout']);
$routes->post('store/debt-repayments/create', 'StoreController::createDebtRepayment', ['filter' => 'access:store.checkout']);
...
$routes->post('store/inventory/restock', 'StoreController::restock', ['filter' => 'access:store.manage_assigned']);
$routes->post('store/inventory/adjust-stock', 'StoreController::adjustStock', ['filter' => 'access:store.manage_assigned']);
$routes->post('store/inventory/add-product', 'StoreController::addProduct', ['filter' => 'access:store.manage_assigned']);
$routes->post('store/inventory/add-product-family', 'StoreController::addProductFamily', ['filter' => 'access:store.manage_assigned']);
$routes->post('store/inventory/update-product', 'StoreController::updateProduct', ['filter' => 'access:store.manage_assigned']);
...
$routes->get('user/card', 'PurchaseCardController::page', ['filter' => 'access:user.self']);
$routes->get('user/purchase-card/status', 'PurchaseCardController::status', ['filter' => 'access:user.self']);
$routes->post('user/purchase-card/unlock', 'PurchaseCardController::unlock', ['filter' => 'access:user.self']);
$routes->post('user/purchase-card/lock', 'PurchaseCardController::lock', ['filter' => 'access:user.self']);
...
$routes->get('user/department-authorizations', 'DepartmentDebtController::legacyUserPage', ['filter' => 'access:user.self']);
...
$routes->get('department/dashboard', 'DepartmentDebtController::departmentDashboard', ['filter' => 'access:user.self']);
$routes->get('department/dashboard/data', 'DepartmentDebtController::departmentDashboardData', ['filter' => 'access:user.self']);
$routes->get('department/authorizations', 'DepartmentDebtController::userPage', ['filter' => 'access:user.self']);
$routes->get('department/authorizations/data', 'DepartmentDebtController::userData', ['filter' => 'access:user.self']);
$routes->post('department/authorizations/pin', 'DepartmentDebtController::setPin', ['filter' => 'access:user.self']);
