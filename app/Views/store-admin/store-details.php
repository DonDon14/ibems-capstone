...
<section class="admin-overview-shell" data-store-id="<?= (int) $storeId ?>" data-details-url="<?= site_url('store-admin/stores/' . (int) $storeId . '/data') ?>" data-review-url-prefix="<?= site_url('store-admin/store-day-sessions') ?>">
    ...
    <div class="overview-table-wrap">
        ...
        <table class="table">
            ...
            <tbody id="sd-inventory-body"><tr><td colspan="3">Loading inventory...</td></tr></tbody>
        </table>
    </div>
    ...
    <div class="overview-table-wrap">
        ...
        <table class="table">
            ...
            <tbody id="sd-transactions-body"><tr><td colspan="4">Loading transactions...</td></tr></tbody>
        </table>
    </div>
</section>
<?= $this->endSection() ?>
